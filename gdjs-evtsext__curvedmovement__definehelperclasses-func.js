...
gdjs.evtsExt__CurvedMovement__DefineHelperClasses.userFunc0x106d6a8 = function(runtimeScene, eventsFunctionContext) {
"use strict";
/**
 * @param {number[]} array 
 * @param {number} value
...
const pathRegex = /[CcSsLlMmHhVvZz]|(?:-?\d+(?:\.\d+)?)/g;
...
gdjs.evtsExt__CurvedMovement__DefineHelperClasses.userFunc0x106d6a8(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
